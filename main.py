...
from app import bp_usuarios, bp_chat, registar_sockets, bp_ui, bp_combate, registrar_sockets_lobby_combate, bp_recompensas, bp_lore
...
app.register_blueprint(bp_lore)
